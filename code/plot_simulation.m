function [] = plot_simulation(t, q, a, r, p, R_RPY, vid)
% Auxiliary function to plot the result of a simulation 
% made with "dyn_model" function and then save it as a video.
% IN - t: title of plot
...
% IN - vid: video on which to write the plot
...
zlabel("y (m)", "fontsize", 16);
set(gca, 'YDir', 'reverse');
title(t, "fontsize", 16);

plot3(p_w(1, :), p_w(3, :), p_w(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "k", "HandleVisibility", "off")
plot3(p_p(1, :), p_p(3, :), p_p(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "k")
plot3(p_t(1, :), p_t(3, :), p_t(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "r")
plot3(p_i(1, :), p_i(3, :), p_i(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "y")
plot3(p_m(1, :), p_m(3, :), p_m(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "g")
plot3(p_r(1, :), p_r(3, :), p_r(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "c")
plot3(p_l(1, :), p_l(3, :), p_l(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "m")
plot3(p_a(1, :), p_a(3, :), p_a(2, :), "linewidth", 5, "marker", "*", "markersize", 7, "color", "k", "HandleVisibility", "off")

view([60.4436 20.0983])
plot_position = [0.3830 0.6777 0.0660, 0.1724];
